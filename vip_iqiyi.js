(function() {
    'use strict';
    var cracks=[
        {name:"点此破解",url:"http://ku.kuuhui.com/svipjx/liulanqichajian/browserplugin/qianru/qianru.php?id=%s",title:"自已点击破解播放"},
		{name:"-------",url:"http://ku.kuuhui.com/svipjx/liulanqichajian/browserplugin/qianru/qianru.php?id=%s",title:"自已点击破解播放"},
    ...
    quickAccess.title="无需点击 立即自动破解播放";
    quickAccess.innerHTML="<input type='checkbox'>自动破解";
    ...
    embedLabel.title="能嵌入当前站点，直接嵌入页面播放 无需跳转";
    embedLabel.innerHTML="<input type='checkbox'>嵌入到页面";
